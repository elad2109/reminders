package com.example.reminders.app.fragments;//package com.example.reminder.fragments;
//
...
//
//public class ReadRemindersFragment extends RoboDialogFragment {
//
...
//		return comments.get(random.nextInt(length));
//	}
//}